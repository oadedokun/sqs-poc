...
namespace StockQuantity.Domain
{
    public class RegionStock
    {
        ...
        private readonly List<WarehouseAvailableStock> _warehouseAvailableStocks;
        ...
        public RegionStock ApplyStockChanges(WarehouseAvailableStock warehouseAvailableAvailableStock)
        {
            ...
            if (_warehouseAvailableStocks != null && _warehouseAvailableStocks.Any())
            {
                ...
                Quantity = WarehouseAvailableStocks.Sum(x => x.Pickable - x.Allocated);
            }
            else
            {
            ...
            Status = Status.Evaluate(Quantity);
